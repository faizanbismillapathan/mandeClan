...
@section('title',"All Subscriptions | service  Mande Clan")
  ...
  <div class="card-padding">
    <div class="account-deactivate">
      ...
      <!--  -->
            ...
            {!!Form::open(['url'=>['service/deactivate-account'],'files' => true, 'class' => ' form-bordered form-row-stripped SendOtpFunction','id' =>'comman_form_id'])!!}
...
$(".ContinueBtn").prop('disabled',true)
    ...
    $.ajax({
      url: "{{ url('service/deactivate-account') }}",
      type:"POST",
...
if (otp) {
    $.ajax({
      url: "{{ url('service/verify_and_deactivate') }}",
      type:"POST",
