...
@section('title',"Payment setting | service Mande Clan")
...
<main class="content">
  ...
  {!! Form::model($bank_detail,array('url' => ['service/bank-detail', $bank_detail->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
  @else
  {!!Form::open(['url'=>['service/bank-detail'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
