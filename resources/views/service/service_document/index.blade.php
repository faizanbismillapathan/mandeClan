  ...
  <main class="content">
                    <div class="container-fluid p-0">
                        ...
                        <div class="clearfix">
                             ...
                             <a href="{{url('service/service-document/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md py-1">
                                                <div class="form-group">
                                                    {{Form::open(['url'=>['service/service-document'],'method'=>'GET'])}}
...
<input type="checkbox" data-toggle="toggle" data-on="Active" data-off="Deactive" data-onstyle="success" data-offstyle="danger" id="{{$data->id}}" class="checkstatus" onchange="updateToggle({{$data->id}})">
   @endif
     ...
     @if($data->status=='Pending')     
                                                <a href="{{ URL::to('service/service-document/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
