...
@section('title',"Create New Photo Gallery | service Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            ...
            <h1 class="h3 mb-3"><b>Create Photo Gallery</b></h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
               ...
               {!!Form::open(['url'=>['service/photo-gallery'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
