...
@section('title',"Edit Photo Gallery | service Mande Clan")
...
<div class="clearfix">
    <a href="{{url('service/photo-gallery')}}" class="form-inline float-right mt--1 d-none d-md-flex">
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['service/photo-gallery', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
...
<a class="btn" href="{{url('service/photo-gallery')}}" style="background-color: #9e9b9b;color: #fff"><i class="fas fa-times"></i>  Cancel</a>
