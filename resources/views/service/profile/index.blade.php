...
@section('title',"My Profile | service Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
          {{--   <a href="{{url('service/services')}}" style="margin-left: 17px;" class="form-inline float-right mt--1 d-none d-md-flex margin">
                <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
            </a> --}}



<h1 class="h3 mb-3"><b>My Profile <span class="badge badge-danger">            {{$record->service_unique_id}}
</span></b></h1>
...
<div class="card">
    ...
    <div class="card-body password_contact">
       ...
       @if(!empty($record))
       {!! Form::model($record,array('url' => ['service/profile', $record->id],'method'=>'PATCH','class'=>'','id' =>'seprate_form_id','files'=>'true')) !!}
...
<div class="form-group col-md-4">
  ...
  {!!Form::text('service_longitude',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','required','id'=>'latitude')) !!} 
</div>

<div class="form-group col-md-4">
  <label for="inputPassword4">Latitude</label>
  {!!Form::text('service_latitude',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','required','id'=>'langitude')) !!} 
</div>
...
@else
  <div class="form-row">
     ...
     <div class="form-group col-md-4">
        ...
        <input type="hidden" name="user_country_code" id="mobile_error" value="">
     ...
     rules: {
          ...
          remote: {
              ...
              console.log($.trim(data));
                 ...
                 return 'true';
                }else if($.trim(data) == "country_code"){
                 return 'false';
                }
                    }
                },
