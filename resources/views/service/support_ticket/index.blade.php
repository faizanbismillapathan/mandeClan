...
@section('title',"All Support Ticket   | Service Mande Clan")
...
<a href="{{url('service/support-ticket/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
...
<div class="row">
<div class="col-md">
{{Form::open(['url'=>['service/support-ticket'],'method'=>'GET'])}}
...
<a href="{{url('service/support-ticket-msg/'.$data->id)}}"><button class="btn btn-info">{{$data->status}}</button></a>
