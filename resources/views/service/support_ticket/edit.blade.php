...
@section('title',"Edit Support Ticket   | Service Mande Clan")
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('route' => ['service/Support-Ticket', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
