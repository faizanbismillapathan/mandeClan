...
@section('title',"Create New Services | service Mande Clan")
    ...
    <div class="container-fluid p-0">
        ...
        <div class="card">
            ...
            <div class="card-body">
               ...
               {!!Form::open(['url'=>['service/services'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label for="inputEmail6">Service Identification id</label>                                                               
                          {!! Form::text('service_unique_id',$keydata,array('class'=>'form-control','readonly'=>'readonly')) !!}
                ...
                <div class="form-group col-md-4">
                 ...
                 <div class="form-group col-md-4">
                    <label for="inputEmail4">Payment Mode</label>                                                   
                     {!!Form::select('service_payment_mode[]',['Online'=>'Online','COD'=>'COD'],null,array('class'=>'form-control select2','data-toggle'=>'select2','autocomplete'=>'off','required','multiple')) !!}
                </div>
