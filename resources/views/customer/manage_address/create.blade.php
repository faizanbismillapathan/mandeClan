...
<div class="card-body password_contact">
        {!!Form::open(['url'=>['customer/manage-address'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'customer_location_form'])!!}

        <div class="form-row">
        <div class="form-group col-md-4">
        <label for="inputEmail4">Name</label>                                                   
        {!!Form::text('name',Auth::user()->name,array('class'=>'form-control','placeholder'=>'Enter name','autocomplete'=>'off','required')) !!} 
        </div>

        <div class="form-group col-md-4">
        <label for="inputEmail4">Email Id</label>                                                   
        {!!Form::email('email',Auth::user()->email,array('class'=>'form-control emailfull','placeholder'=>'Email Id','autocomplete'=>'off','required')) !!} 
        </div>

        <div class="form-group col-md-4">
        <label for="inputEmail4">Mobile No</label>                                                   
        {{-- {!!Form::text('mobile',Auth::user()->mobile,array('class'=>'form-control','placeholder'=>'Enter name','autocomplete'=>'off','required')) !!}  --}}
...
<input type="hidden" name="user_country_code" id="phone3" value="">
        ...
        {!!Form::select('state',[],null,array('class'=>'form-control basemap select2 state_selector','placeholder'=>'','data-toggle'=>'select2','required')) !!}

        </div>

        <div class="form-group col-md-4">
        <label for="inputEmail4">City</label>                                                   
        {!!Form::select('city',[],null,array('class'=>'form-control basemap select2 city_selector','placeholder'=>'','data-toggle'=>'select2','required')) !!}
        </div>

        <div class="form-group col-md-4">
        <label for="inputEmail4">Locality</label>                                                   
        {!!Form::select('locality',[],null,array('class'=>'form-control basemap locality_selector select2','placeholder'=>'','data-toggle'=>'select2','required')) !!}
        </div>
...
<input type="hidden" name="map_address" id="search-txt" value="">
        ...
        {!!Form::text('address',null,array('class'=>'form-control basemap','placeholder'=>'Enter Address','autocomplete'=>'off','required','id'=>'shopaddress')) !!} 
        </div>
        <div class="form-group col-md-3">
...
{!!Form::text('longitude',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','id'=>'langitude')) !!} 
</div>

<div class="form-group col-md-2">
<label for="inputPassword2">Latitude</label>
{!!Form::text('latitude',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','id'=>'latitude')) !!} 
</div>
