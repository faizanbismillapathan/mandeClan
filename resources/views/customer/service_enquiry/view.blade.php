...
@section('title',"All Category List| customer Mande Clan")
...
?></span> </div>
         ...
         @endif
          ...
          {!!Form::open(['url'=>['customer/service-enquiry'],'files' => true, 'class' => ' form-bordered form-row-stripped','method' =>'post'])!!}
   @if(!empty($id))
            <input type="hidden" name="service_booking_id" value="{{$id}}"> 

  @endif
              <input type="hidden" name="service_user_id" value="{{$event_records->service_user_id}}"> 
