...
@section('title',"Create New Support Ticket   | Customer Mande Clan")
...
{!!Form::open(['url'=>['customer/support-ticket'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
