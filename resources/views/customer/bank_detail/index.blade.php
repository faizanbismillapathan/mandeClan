...
@section('title',"Payment setting | customer Mande Clan")
...
<main class="content">
  ...
  {!! Form::model($bank_detail,array('url' => ['customer/bank-detail', $bank_detail->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
  @else
  {!!Form::open(['url'=>['customer/bank-detail'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
