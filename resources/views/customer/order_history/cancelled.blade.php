...
<div class="col-md-12" style="padding:0;">
    ...
    </span> {{$data->pickup_type}}
    <span style="font-size:0.9rem;font-weight:bold;text-align:right;float: right;">Cancel Order At : <span>{{date('d-M-y',strtotime($data->order_status_date))}} </span>  </span>
