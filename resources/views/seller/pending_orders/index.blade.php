...
@section('title',"All Pending Orders | seller Mande Clan")
                ...
                <div class="col-md-12">
                    ...
                    <div onclick="orderget('2')" id="orderbox2" class="orderbox">
                        <div class="card mb-3">
                            ...
                            <div class="card-body seller-order">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                       <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <i class="fas fa-dollar-sign"></i> 65.86
                                            <br>
    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{url('/')}}/seller/quick/confirm/fullorder/2" method="POST">
...
<div id="confirm1" class="delete-modal modal fade" role="dialog">
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{url('/')}}/seller/quick/confirm/fullorder/1" method="POST">
                    <input type="hidden" name="_token" value="sA7ntz1dHvzRSYy4bJwwLwzAlbimzECl2NkN11rY">                                        <input type="hidden" name="status" value="processed">
