...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['seller/products', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
 ...
 <div class="form-group col-md-4">
          ...
          --}}
            ...
            <div class="form-group col-md-4">
                ...
                </label>  <br>                                                                     <input type="checkbox"  {{ $record->product_free_shipping ==  'Enable' ? 'checked' : ''  }}  data-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" id="11" class="checkstatus"  name="product_free_shipping">
            ...
            <div class="form-group col-md-4">
                <label for="inputEmail4">Status</label> <br>                                                                       <input type="checkbox"  {{ $record->product_status ==  'Active' ? 'checked' : ''  }}  data-toggle="toggle" data-on="Active" data-off="Deactive" data-onstyle="success" data-offstyle="danger" id="11" class="checkstatus"  name="product_status">
            ...
            <div class="form-group col-md-4">
                <label for="inputEmail4">Cancel Available :</label> <br>                                                                     {{--   <input type="checkbox"  {{ $record->product_cancel_available ==  'Enable' ? 'checked' : ''  }}  checked data-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" id="11" class="checkstatus"  name="product_cancel_available">
 --}}

   <input type="checkbox"  {{ $record->product_cancel_available ==  'Enable' ? 'checked' : ''  }}  data-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" id="11" class="checkstatus"  name="product_cancel_available">

            </div>

            <div class="form-group col-md-4">
                <label for="inputEmail4">Cash On Delivery :</label> <br>                                                                       <input type="checkbox"  {{ $record->product_cod ==  'Enable' ? 'checked' : ''  }}  data-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" id="11" class="checkstatus"  name="product_cod">
