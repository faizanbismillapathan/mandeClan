             ...
             @endif</td>
                                                ...
                                                <td>{{$data->product_subcategory}}</td>
                                                  <td><a href="{{url('seller/products/'.$data->id.'/items')}}"><button class="btn-info">Add Items</button></a></td>
                                                    {{-- @if(in_array($checks->category_name,['Ready Food','Bakery','Restaurants','Convenience'])) <td><a href="{{url('seller/products/'.$data->id.'/addon')}}"><button class="btn-secondary">AddOn</button></a></td>@endif --}}
...
<input type="checkbox" data-toggle="toggle" data-on="Active" data-off="Deactive" data-onstyle="success" data-offstyle="danger" id="{{$data->id}}" class="checkstatus" onchange="updateToggle({{$data->id}})">
   @endif
                                                ...
                                                <a href="{{ URL::to('seller/products/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
...
swal({
  ...
  confirmButtonText: 'Yes, Remove it!'
    ...
    $.ajax({
           type:"POST",
                     url: "{{url('seller/products/delete')}}",
