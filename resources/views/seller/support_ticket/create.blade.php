...
@section('title',"Create New Support Ticket   | Seller Mande Clan")
...
{!!Form::open(['url'=>['seller/support-ticket'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
