...
@section('title',"All Support Ticket   | Seller Mande Clan")
...
<a href="{{url('seller/support-ticket/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
...
<div class="row">
<div class="col-md">
{{Form::open(['url'=>['seller/support-ticket'],'method'=>'GET'])}}
...
<a href="{{url('seller/support-ticket-msg/'.$data->id)}}"><button class="btn btn-info">{{$data->status}}</button></a>
