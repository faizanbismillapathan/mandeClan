...
@section('title',"Edit Subscriptions | seller  Mande Clan")
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['seller/subscriptions', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
...
<a class="btn" href="{{url('seller/subscriptions')}}" style="background-color: #9e9b9b;color: #fff"><i class="fas fa-times"></i>  Cancel</a>
