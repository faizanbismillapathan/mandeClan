...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            ...
            <h1 class="h3 mb-3"><b>Change Mobile No
            </b></h1>
          ...
          <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                       <div class="col-md-12 m-auto center">
                        <h4>Update Mobile</h4>
  ...
  <div class="card-padding">
    ...
    <div class="account-deactivate">
        <div>
                                       ...
                                       <h3 class="center">{{$record->mobile}}</h3>
<h5 class="center py-3"> Remember! This action will update your mobile number.</h5>

              <form id="first_form" class="change_form_cls m-auto px-5 otp_show hide otp_ids">
...
<div class="m-auto pt-3 center" style="">
          <button  class=" px-2  btn btn-success btn-custome custom-cheryred ContinueBtn hide" id="td_id" style="margin: 10px">Verify</button>

          <button type="button" class=" px-2  btn btn-success btn-custome VerifyOtpFunction custom-cheryred hide" id="td_id" style="margin: 10px">Verify</button>
      ...
      <!--  -->
           ...
           <div class="center">
            ...
            <button type="button" class="btn btn-info submits center"><i class="fab fa-telegram-plane"></i> Send otp On mobile</button>
           </div>
            ...
            <div class="change-contactnos m-auto center" style="display:none;" >
             {!!Form::open(['url'=>['seller/seller-update-mobile'],'files' => true, 'class' => ' form-bordered form-row-stripped','id'=>'change_mobile_form'])!!}

             <div class="row m-auto">
              <div class="col-md-6 m-auto center">
               
                <div class="form-group">
                  <label class="bmd-label-floating">Enter New mobile</label> <br/>
                  {{-- {!!Form::text('store_mobile',null,array('class'=>'form-control mobilefull','autocomplete'=>'off','required','id'=>'mobile_id')) !!}  --}}
          ...
          <br/> <br/> <br/>
                                      ...
                                      <button type="submit" class="btn btn-info  center m-auto">Change mobile</button>
                </div>
          ...
          remote: {
                    ...
                    data: {
                        check_store_owner_mobile: function () {
                            ...
                            return '+'+$("#phone3").val()+$("input[name='store_mobile']").val();
                        }
                    },
...
$(".ContinueBtn").prop('disabled',true)
    ...
    $.ajax({
      url: "{{ url('seller/change-contactno') }}",
      type:"POST",
...
var mobile='+'+$("#phone3").val()+$("#mobile_id").val();
...
var otp =$("#otp").val();
var mobile='{{$record->mobile}}';
var chh=$("#mobile_id").val();
var new_mobile='';

if(chh){

    var new_mobile='+'+$("#phone3").val()+$("#mobile_id").val();
...
if (otp) {
    $.ajax({
      url: "{{ url('seller/verify_seller_mobile') }}",
      type:"POST",
      
    data: {otp:otp,mobile:mobile,new_mobile:new_mobile},
