    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card m-b-30 bg-primary-rgba text-muted rounded p-2 mt-2">
                <div class="card-body">
                    <p class="card-text"><b>Order Placed On :</b> 24/10/2021 - 06:37 am</p>
                    <p class="card-text"><b>Order ID :</b> EODD6175302cad557</p>

                    <p class="card-text"><b>Total qty. :</b> 4</p>
                    <p class="card-text"><b>Order Total :</b> 268</p>
                    <p class="card-text"><b>Tip :</b> $ 10</p>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <img width="60px" class="object-fit" src="{{url('/')}}/images/simple_products/thum_dgp_60c34d8be914b.png" alt="">
                                    </div>
    ...
    <div class="col-md-12 ml-2">
        ...
        <span id="logs">
            <small>22-09-2021 | 09:24:am • For Order
                ...
                :                       <span class="text-danger"><b>seller</b> (seller)</span> changed status to
                <b>Processed</b>
