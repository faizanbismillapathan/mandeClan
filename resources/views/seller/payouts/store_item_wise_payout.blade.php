...
@section('title',"Create Store Wise Payout | seller Mande Clan")
...
{{-- {{ 'seller/store-item-wise-payout/'.Request::segment(3).'?from_date='.Request::Input('from_date').'&to_date='.Request::Input('to_date').'&store_id='.Request::Input('store_id') }} --}}


            {{Form::open(['url'=>['seller/store-item-wise-payout/'.Request::segment(3).'?from_date='.Request::Input('from_date').'&to_date='.Request::Input('to_date').'&store_id='.Request::Input('store_id')],'method'=>'GET'])}}
...
<div class="col-md">
                <a href="{{ url('seller/store-item-wise-pdf-payout?from_date='.Request::Input('from_date').'&to_date='.Request::Input('to_date').'&store_id='.$record->id) }}"><button type="button" class="btn btn-info"><i class="fa fa-download mx-1 text-secondar"></i></button></a>

                   <a href="{{ url('seller/store-item-wise-excel-payout?from_date='.Request::Input('from_date').'&to_date='.Request::Input('to_date').'&store_id='.$record->id) }}"><button type="button" class="btn btn-success"><i class="fa fa-file-excel mx-1 text-secondar"></i></button></a>
