...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            <a href="{{url('seller/products/'.$record->product_id.'/items')}}" class="form-inline float-right mt--1 d-none d-md-flex">
...
@foreach($records as $index=>$data)
                      <li class="nav-item">
                        ...
                        <a  href="{{ URL::to('seller/product-items/'.$data->id.'/edit') }}" class="nav-link  {{$data->id ==\Request::segment(3)  ? 'active' : ''}}"> &nbsp;&nbsp;
