...
@section('title',"Create New Photo Gallery | seller Mande Clan")
    ...
    <div class="container-fluid p-0">
        ...
        <div class="card">
            ...
            <div class="card-body">
               ...
               {!!Form::open(['url'=>['seller/photo-gallery'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
