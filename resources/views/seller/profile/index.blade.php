...
@section('title',"My Profile | seller Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            {{-- <a href="{{url('seller/stores')}}" style="margin-left: 17px;" class="form-inline float-right mt--1 d-none d-md-flex margin">
                <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
            </a> --}}



<h1 class="h3 mb-3"><b>My Profile <span class="badge badge-danger">            {{$record->store_unique_id}}
</span></b></h1>
...
<div class="card">
    ...
    <div class="card-body password_contact">
       ...
       @if(!empty($record))
       {!! Form::model($record,array('url' => ['seller/profile', $record->id],'method'=>'PATCH','class'=>'','id' =>'seprate_form_id','files'=>'true')) !!}
...
<fieldset class="scheduler-border">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      @if(!empty($countries))
      {!!Form::select('store_country',$countries,null,array('class'=>'form-control select2 basemap selector','placeholder'=>'Select Country','data-toggle'=>'select2','required')) !!}
      @endif
  </div>
  <div class="form-group col-md-4">
      ...
      @if(!empty($states))
      {!!Form::select('store_state',$states,null,array('class'=>'form-control select2 basemap state_selector','placeholder'=>'Select Country','data-toggle'=>'select2','required')) !!}
      @else
      {!!Form::select('store_state',[],null,array('class'=>'form-control select2 basemap state_selector','placeholder'=>'Select Country','data-toggle'=>'select2','required')) !!}
      @endif                     
  </div>
  ...
  <div class="form-group col-md-4">
      ...
      @if(!empty($cities))
      {!!Form::select('store_city',$cities,null,array('class'=>'form-control select2 basemap city_selector','placeholder'=>'Select City','data-toggle'=>'select2','required')) !!}
      @else
      {!!Form::select('store_city',[],null,array('class'=>'form-control select2 basemap city_selector','placeholder'=>'Select City','data-toggle'=>'select2','required')) !!}
      @endif                  
  </div>
...
<div class="form-group col-md-4">
  ...
  {!!Form::text('store_longitude',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','required','id'=>'latitude')) !!} 
</div>

<div class="form-group col-md-4">
  <label for="inputPassword4">Latitude</label>
  {!!Form::text('store_latitude',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','required','id'=>'langitude')) !!} 
</div>
      ...
      {{--   <div class="form-group col-md-4 ">
           <div class="form-group author-img-bx">
            ...
            <div class="fileupload fileupload-new" data-provides="fileupload">
               ...
               <div class="row">
                   <div class="col-md-12">
                      <button type="button" class="btn" style="padding: 0px; background-color: #fff;"><span class="btn btn-default btn-file">
                        <span class="btn btn-secondary fileupload-new">Choose image</span>
                        <span  class="btn btn-secondary fileupload-exists">Change</span>

                        {{ Form::file('store_logo',null, ['class' => 'form-control','required']) }}</span>
            ...
            <div class="row">
               <div class="col-md-12">
                  <button type="button" class="btn " style="padding: 0px; background-color: #fff;"><span class="btn btn-default btn-file">
                    ...
                    {{ Form::file('store_cover_photo',null, ['class' => 'form-control','required']) }}</span>
...
{{-- <fieldset class="scheduler-border">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
          ...
          {!!Form::select('store_plan_id',$subscriptions,null,array('class'=>'form-control','placeholder'=>'Select Plan')) !!}
      </div>
      <div class="form-group col-md-4">
...
<fieldset class="scheduler-border">
  ...
  <div class="form-row">
                         ...
                         <div class="form-group col-md-12">
                          <div class="row">
                            <div class="col-md-3"><b>Store Mobile</b></div>
                            <div class="col-md-1"><b>:</b></div>
                            <div class="col-md-4">{{$users->mobile}} </div>
                             <div class="col-md-3"> <a href="{{url('seller/change-contactno')}}"> <button type="button" class="btn btn-info">Change Mobile</button></a> </div>
                         ...
                         <div class="form-group col-md-12">
                          <div class="row">
                            ...
                            <div class="col-md-1"><b>:</b></div>
                            <div class="col-md-4"> {{$users->email}}
...
@endif
                            ...
                            <div class="col-md-3"><a href="{{url('seller/change-email')}}"><button type="button" class="btn btn-info">Change Email</button></a></div>
                          </div>         
                        </div>
                        <div class="form-group col-md-12">
                          <div class="row">
                            <div class="col-md-3"><b class="">Password</b></div>
                            <div class="col-md-1"><b>:</b></div>
                            <div class="col-md-4">{{$record->store_password}}


                            </div>
                            <div class="col-md-3"><a href="{{url('seller/change-password')}}"><button type="button" class="btn btn-info">Change Password</button></a></div>
                          </div>         
                        </div>
</div>
...
@else
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
          ...
          {!!Form::text('store_mobile',null,array('class'=>'form-control numbersOnly','placeholder'=>'','autocomplete'=>'off','required','id'=>'mobile_id','minlength'=>'10' ,'maxlength'=>'10')) !!} 
...
<script type="text/javascript">
 ...
 $('.password_contact').on('click','.toggle-password', function(){
  ...
  if (input.attr("type") == "password") {
   ...
   //      $('.viewmodelwithmap').on('click',function(){
   ...
   //         {
   //            $('#bodyofmapmodal #info').html();
   //        }else{
   //        // var cred = "21.1653977,79.0818300";
   //        //  document.getElementById('info').innerHTML = [
   //        //     "21.247336679959897",
   //        //     "79.70805070312497"
   //        //   ].join(', ');
   //        // $('#bodyofmapmodal #info').html('');
   //        // $('#bodyofmapmodal #info').html(cred); 
   //    }
   //     // $('#mainmapmodal').modal('show');
   // });


   //      $('.confirm_address_set_field').on('click',function(){
   //       var latlong = $('#bodyofmapmodal #info').text();
   //       var address = $('#bodyofmapmodal #address').text();
   //       var $mapll = latlong.split(",");
   //       $('#latitude').val($mapll[0]);
   //       $('#langitude').val($mapll[1]);
   //       $('#shopaddress').val(address);
   //     // $('#mainmapmodal').modal('hide');
   // });
...
// function initialize() {
//  var formlatitude = $('#latitude').val();
//  var formlangitude = $('#langitude').val();
//  if(formlatitude == ''){
//     var formlatitude = 21.1653977;
//     var formlangitude = 79.0818300;
// }else{
//     var formlatitude = $('#latitude').val();
//     var formlangitude = $('#langitude').val();
// }
// var latLng = new google.maps.LatLng(formlatitude,formlangitude);
...
var final='Block No. 15, 4th Floor, JB Wing, Mangalwari Complex,, Near Sadar Bazaar Road, Civil Lines, Nagpur, Maharashtra 440001, India';
