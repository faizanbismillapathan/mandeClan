...
<div class="clearfix">
    <a href="{{url('admin/service-category')}}" class="form-inline float-right mt--1 d-none d-md-flex">
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/service-category', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
...
<a class="btn" href="{{url('admin/service-category')}}" style="background-color: #9e9b9b;color: #fff"><i class="fas fa-times"></i>  Cancel</a>
