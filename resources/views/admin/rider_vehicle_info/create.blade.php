...
@section('title',"Create New Rider / Vehicle | Admin Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            ...
            <h1 class="h3 mb-3"><b>Create Rider / Vehicle</b></h1>
        ...
        <div class="card">
            ...
            <div class="card-body password_contact">
             ...
             {!!Form::open(['url'=>['admin/rider-vehicle-info'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'seprate_form_id'])!!}
                  ...
                  <div class="col-md-8">
                   <div class="form-row">
                     <div class="form-group col-md-6">
                        ...
                        {!! Form::text('rv_user_userid',$keydata,array('class'=>'form-control','readonly'=>'readonly')) !!}
                    </div>
                  ...
                  <div class="row">
                      <div class="col-md-6">
                         <label class="custom-control custom-checkbox">
                            {{ Form::checkbox('rv_user_type[]', 'Rider' , true,array('class'=>'custom-control-input rv_user_type_cls')) }}

                            <span class="custom-control-label">Rider</span>
                        </label>                             
                    </div>
                    <div class="col-md-6"> <label class="custom-control custom-checkbox">
                        {{ Form::checkbox('rv_user_type[]', 'Vehicle Owner' , false,array('class'=>'custom-control-input rv_user_type_cls')) }}                    <span class="custom-control-label">Vehicle Owner</span>
                    </label></div>
...
<!-- 
                          <div class="form-group col-md-6 hideon_vehicle">
                             ...
                             <div class="form-group col-md-6 hideon_vehicle">
                              ...
                              {!!Form::text('deposit_amount',null,array('class'=>'form-control numbersOnlhy','placeholder'=>'','autocomplete'=>'off')) !!} 
                          </div> -->
                      </div>
                  </div>
...
<div class="form-group author-img-bx hideon_vehicle" >
...
<fieldset class="scheduler-border">
  ...
  <div class="form-group col-md-4">
      ...
      {!!Form::text('rv_user_login_email',null,array('class'=>'form-control emailfull','placeholder'=>'','autocomplete'=>'off','required')) !!}
  ...
  <div class="form-group col-md-4">
      ...
      <input id="password-field" type="password" class="form-control" name="rv_user_password" value="">
...
<script type="text/javascript">
    $(document).ready(function() {
     ...
     $(".rv_user_type_cls").click(function() {


      var arr = $(".rv_user_type_cls:checked").map(function(){
          return $(this).val();
      }).get();

      console.log(arr);

      if(arr[0]=='Rider' || arr[1]=='Rider')   
        $(".hideon_vehicle").show();
    else
        $(".hideon_vehicle").hide();
});
