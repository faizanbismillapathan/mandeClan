...
@section('title',"Edit Offline Payment Process | Admin Mande Clan")
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Update Offline Payment Process</b></h1>
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/offline-payment', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
            ...
            <div class="fileupload-new img-thumbnail" style="width: 180px; height: 120px;">
             <!-- <img src="{{ asset('public/img/no-image.png')}}" alt="dd" /> -->
               ...
               @if(!empty($record->thumbnail))
                   <img src="{{ asset('public/images/thumbnail/'.$record->thumbnail)}}" alt="dd" />
                   @else
                   <img src="{{ asset('public/img/no-image.png')}}" alt="dd" />
                   @endif
