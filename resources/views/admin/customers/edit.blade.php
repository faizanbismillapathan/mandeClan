...
<div class="card-body password_contact">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/customers', $record->id],'method'=>'PATCH','class'=>'','id' =>'seprate_form_id','files'=>'true')) !!}
                        ...
                        <div class="form-group col-md-4">
                          <div class="row">
                            ...
                            <div class="col-md-6">{{$pass}}
                              {{-- <button type="button" class="btn btn-info">Change Password</button> {{$record->store_password}} --}}
                            </div>
                          </div>         
                        </div>
</div>
