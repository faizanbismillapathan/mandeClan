...
@section('title',"Create New Service | Admin Mande Clan")
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Create Services</b></h1>
...
<div class="card-body password_contact">
             ...
             {!!Form::open(['url'=>['admin/services'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'seprate_form_id','autocomplete'=>'off'])!!}
...
<div class="form-row">
     <div class="form-group col-md-4 ">
          ...
          {!!Form::select('service_category',$categories,null,array('class'=>'form-control select2 selectcategory ','placeholder'=>'Select Category','data-toggle'=>'select2','required')) !!}

      </div>

      <!--  <div class="form-group col-md-4 ">
          <label for="inputEmail4">Select Service Category</label>
          {!!Form::select('service_product_category[]',[],null,array('class'=>'form-control select2 ','placeholder'=>'Select Category','data-toggle'=>'select2','required','multiple')) !!}
     ...
     <div class="form-group col-md-4">
                         ...
                         {{--  <div class="form-group col-md-4">
                          ...
                          {!!Form::text('service_mobile',null,array('class'=>'form-control contact_no_validate','minlength'=>'10' ,'maxlength'=>'13','placeholder'=>'','autocomplete'=>'off','required')) !!} 
                        </div> --}}
  <div class="form-group col-md-4">
                          <label for="inputPassword4">Email</label>
                          {!!Form::text('service_owner_email',null,array('class'=>'form-control emailfull','placeholder'=>'','autocomplete'=>'off','required')) !!} 
                        ...
                        <div class="form-group col-md-4">
                         ...
                         {{--  <div class="form-group col-md-4">
                          <label for="inputPassword4">Service Phone</label>
                          {!!Form::text('service_phone',null,array('class'=>'form-control contact_no_validate','minlength'=>'10' ,'maxlength'=>'13','placeholder'=>'','autocomplete'=>'off')) !!} 
                        </div>
 ...
 --}}
                        ...
                        <div class="form-group col-md-4">
                          ...
                          {!!Form::url('service_website',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off')) !!} 
                        </div>

                           <div class="form-group col-md-4">
                          <label for="inputPassword4">Facebook URL</label>
                          {!!Form::url('service_facebook_url',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off')) !!} 
                        </div>
                         <div class="form-group col-md-4">
                          <label for="inputPassword4">Instagram URL</label>
                          {!!Form::url('service_instagram_url',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off')) !!} 
                        </div>
                         <div class="form-group col-md-4">
                          <label for="inputPassword4">You tube URL</label>
                          {!!Form::url('service_you_tube_url',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off')) !!} 
                        </div>
                         <div class="form-group col-md-4">
                          <label for="inputPassword4">Twitter URL</label>
                          {!!Form::url('service_twitter_url',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off')) !!} 
                        </div>
           ...
           <div class="row">
             <div class="col-md-12">
              <button type="button" class="btn btn-secondary" style="padding: 0px; background-color: #fff;"><span class="btn btn-default btn-file">
                ...
                {{ Form::file('service_cover_photo',null, ['class' => 'form-control','required']) }}</span>
...
<div class="form-row">
 ...
 <div class="form-group col-md-4">
                         ...
                         <div class="form-group col-md-4">
                          ...
                          {!!Form::text('service_paytm_mobile',null,array('class'=>'form-control paytm_mobile','placeholder'=>'','autocomplete'=>'off')) !!} 
                        </div>
                         <div class="form-group col-md-4">
...
<input id="password-field" type="password" class="form-control" name="service_password" value="" required>
...
//                         console.log(data);
//                    $('select[name="service_product_category[]"]').empty();
                          
//                   $('select[name="service_product_category[]"]').append('<option value="'+''+'">'+'None'+'</option>');
//                    $.each(data, function(key, value) { 
//                   $('select[name="service_product_category[]"]').append('<option value="'+ key +'">'+value+'</option>');
//                  });
//                 }
...
// console.log(service_country[0].text,'service_country')
// console.log(service_state[0].text,'service_state')
// console.log(service_city[0].text,'service_city')
// console.log(service_locality[0].text,'service_locality')
// console.log(service_pincode[0].text,'service_pincode')

var final=service_locality[0].text+', '+service_city[0].text+', '+service_state[0].text+' '+service_pincode+', '+service_country[0].text;
