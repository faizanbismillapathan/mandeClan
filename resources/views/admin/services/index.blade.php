...
@section('title',"All Services | Admin Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="clearfix">
           ...
           <a href="{{url('admin/services/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
             <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create a New Service</button>
         </a>
     ...
     <div class="card">
        <div class="card-body">
                    {{Form::open(['url'=>['admin/services'],'method'=>'GET'])}}
...
<table class="table table-striped table-hover table-sm table-bordered table-responsive" >
    ...
    <tbody>
        ...
        <tr class="deleteRow {{ $data->user_status=='Default' ? 'default_cls' : '' }}">
            ...
            <td style="color: #e91e63;text-decoration :underline; " data-toggle="tooltip" data-placement="top" title="Go to Service Panel" class=" clickable-row" data-href="{{ URL::to('service/dashboard/'.$data->id) }}" data-underline>
 ...
 <td>
            @if($data->email_verified_at)
               <span class="badge badge-success" data-toggle="tooltip" data-placement="top" title="{{$data->service_email}}">Verified</span>
@else
               <span class="badge badge-danger" data-toggle="tooltip" data-placement="top" title="{{$data->service_email}}">Not verify</span>
...
@else
           ...
           @endif
           <td>                                                    
            <a href="{{ URL::to('admin/services/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
