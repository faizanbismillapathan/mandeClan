...
">delivery date</th>
	...
	<th width="10%">Total Store/Items</th>
...
<td><a href="{{url('admin/order_items/'.$data->id)}}">{{$data->order_u_id}}</a>  
<br>
...
<td>{{$data->total_suborder}}/{{$data->total_order_item}}</td>
...
<td>
<a href="{{url('admin/order-invoice-pdf/'.$data->id)}}"><button class="btn bmd-btn-icon btn-raised btn-secondary" type="button">
