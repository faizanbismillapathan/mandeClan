...
@section('title',"Edit City | Admin Mande Clan")
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Update City</b></h1>
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/city', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
       ...
       @endif
                                           ...
                                           <div class="form-row">
                                                ...
                                                <label for="inputEmail4"> Select State</label>
                                                    @if(!empty($cities))
                                                    {!!Form::select('state_id',$cities,null,array('class'=>'form-control select2','placeholder'=>'Select State','id'=>'','data-toggle'=>'select2','autocomplete'=>'off','required')) !!}
                                                    @else
