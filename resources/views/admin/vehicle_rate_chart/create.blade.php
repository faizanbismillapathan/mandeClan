...
@section('title',"Create New Vehicle Type | Admin Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            ...
            <h1 class="h3 mb-3"><b>Create Vehicle Type</b></h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
               ...
               {!!Form::open(['url'=>['admin/vehicle-rate-chart'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
                  ...
                  <div class="form-row">
                   ...
                   <div class="form-group col-md-4">
                    ...
                    {!! Form::text('vehicle_rate_chart_id',$keydata,array('class'=>'form-control','readonly'=>'readonly')) !!}
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    {!!Form::select('vehicle_wheel',[],null,array('class'=>'form-control select2','placeholder'=>'Select Country','data-toggle'=>'select2','required')) !!}
                </div>
        ...
        headers: {
          ...
          data: {id:vehicleId},
              ...
              // $('select[name="vehicle_fuel"]').empty();   
                  ...
                  $('select[name="vehicle_wheel"]').append('<option value="'+ key +'">'+value+'</option>');
                 });
                }
