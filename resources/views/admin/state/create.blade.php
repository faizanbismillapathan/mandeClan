...
@section('title',"Create New State | Admin Mande Clan")
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Create state</b></h1>
...
<div class="card-body">
             ...
             {!!Form::open(['url'=>['admin/state'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
...
$('#comman_form_id').validate({
     ...
     rules: {
          ...
          remote: {
                    url: "{{url('admin/check_unique_state')}}",
                    type: "post",
