...
@section('title',"Create New Store | Admin Mande Clan")
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Create Stores</b></h1>
...
<div class="card-body password_contact">
             ...
             {!!Form::open(['url'=>['admin/stores'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'seprate_form_id','autocomplete'=>'off'])!!}
...
<div class="form-row">
     <div class="form-group col-md-4 ">
          ...
          {!!Form::select('store_category',$categories,null,array('class'=>'form-control select2 selectcategory ','placeholder'=>'Select Category','data-toggle'=>'select2','required')) !!}
  ...
  <legend class="scheduler-border">Store Locations &nbsp;:</legend>
   <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          @if(!empty($countries))
                          {!!Form::select('store_country',$countries,null,array('class'=>'form-control basemap select2 selector','placeholder'=>'','data-toggle'=>'select2','required')) !!}
                          @endif
                        </div>
<div class="form-group col-md-4">
                          <label for="inputEmail4">State</label>
                         
{!!Form::select('store_state',[],null,array('class'=>'form-control basemap select2 state_selector','placeholder'=>'','data-toggle'=>'select2','required')) !!}
 ...
 {!!Form::select('store_city',[],null,array('class'=>'form-control basemap select2 city_selector','placeholder'=>'','data-toggle'=>'select2','required')) !!}
 ...
 {!!Form::select('store_locality',[],null,array('class'=>'form-control basemap locality_selector select2','placeholder'=>'','data-toggle'=>'select2','required')) !!}
...
<div class="form-group col-md-4">
                          ...
                          {!!Form::text('store_longitude',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','id'=>'langitude')) !!} 
                        </div>

                        <div class="form-group col-md-4">
                          <label for="inputPassword4">Latitude</label>
                          {!!Form::text('store_latitude',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','id'=>'latitude')) !!} 
                        </div>
...
<input id="password-field" type="password" class="form-control" name="store_password" value="" required>
