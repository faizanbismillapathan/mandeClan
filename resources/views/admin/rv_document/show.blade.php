...
{{-- 
 ...
 --}}
                            <h1 class="h3 mb-3">Service Partner Document &nbsp;&nbsp;@if(!empty($records))({{$records->total()}})@endif</h1>
                        </div>
...
swal({
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    $.ajax({
           ...
           url:"{{url('/admin/rv-document/delete')}}",
...
swal({
  ...
  function() {
       ...
       $.ajax({
           type:"post",
           url:"{{url('/admin/rv-document/status_update')}}",
