...
@section('title',"Create New Service Partner Document | service partner Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            ...
            <h1 class="h3 mb-3"><b>Create Service Partner Document</b></h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
               ...
               {!!Form::open(['url'=>['admin/rv-document'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
                    ...
                    <div class="form-group col-md-4">
                        ...
                        {!!Form::file('document_file',array('class'=>'form-control','placeholder'=>'Enter Service Partner Document','autocomplete'=>'off','required')) !!} 
