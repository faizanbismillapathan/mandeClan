...
@section('title',"All Pages | Admin Mande Clan")
  ...
  <main class="content">
                    <div class="container-fluid p-0">
                        ...
                        <div class="clearfix">
                             ...
                             {{-- <a href="{{url('admin/pages/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
                                       <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create a New Page</button>
                                    </a> --}}

                            <h1 class="h3 mb-3">Pages &nbsp;&nbsp;@if(!empty($records))({{$records->total()}})@endif</h1>
                        </div>
                        ...
                        <div class="card">
                                <div class="card-body">
                                        <div class="row">
                                            <div class="col-md">
                                            {{Form::open(['url'=>['admin/pages'],'method'=>'GET'])}}
                                            
@if(!empty($page))
                        {!!Form::select('search',$page,Request::input('search'),array('class'=>'form-control select2','placeholder'=>'Search','data-toggle'=>'select2','onchange'=>'this.form.submit()','id'=>'test_skill')) !!}

                        
<!--                                                 {!!Form::select('search',$page,null,array('class'=>'form-control select2','placeholder'=>'Search','data-toggle'=>'select2','onchange'=>'this.form.submit()')) !!}
 -->@endif
...
<input type="checkbox" data-toggle="toggle" data-on="Active" data-off="Deactive" data-onstyle="success" data-offstyle="danger" id="{{$data->id}}" class="checkstatus" onchange="updateToggle({{$data->id}})">
   @endif
                                                ...
                                                <td>                                                    
                                                <a href="{{ URL::to('admin/pages/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
