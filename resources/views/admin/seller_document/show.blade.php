...
@section('innercontent')
  ...
  <main class="content">
                    <div class="container-fluid p-0">
                        ...
                        <div class="clearfix">
 <a href="{{url('admin/seller-document')}}" class="form-inline float-right mt--1 d-none d-md-flex">
 ...
 --}}
                        ...
                        <div class="card">
                         ...
                         <div class="form-group col-md-4">
                          <div class="row">
                            ...
                            <div class="col-md-6">{{$record->store_name}}</div>
                          </div>         
                        </div>
                        ...
                        <div class="form-group col-md-4">
                          <div class="row">
                            ...
                            <div class="col-md-1"><b>:</b></div>
                            <div class="col-md-6">{{$record->store_mobile}}</div>
                          </div>         
                        </div>
                        <div class="form-group col-md-4">
                          <div class="row">
                            ...
                            <div class="col-md-1"><b>:</b></div>
                            <div class="col-md-6">{{$record->store_email}} </div>
                          </div>         
                        </div>
                        <div class="form-group col-md-4">
                          <div class="row">
...
swal({
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    $.ajax({
           ...
           url:"{{url('/admin/seller-document/delete')}}",
...
swal({
  ...
  function() {
       ...
       $.ajax({
           type:"post",
           url:"{{url('/admin/seller-document/status_update')}}",
