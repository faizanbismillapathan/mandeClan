...
@section('title',"Create New Seller Document | seller Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            ...
            <h1 class="h3 mb-3"><b>Create Seller Document</b></h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
               ...
               {!!Form::open(['url'=>['admin/seller-document'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
                    ...
                    <div class="form-group col-md-4">
                        ...
                        {!!Form::file('document_file',array('class'=>'form-control','placeholder'=>'Enter Seller Document','autocomplete'=>'off','required')) !!} 
