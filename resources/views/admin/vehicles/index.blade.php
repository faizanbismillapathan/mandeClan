...
@section('title',"All Vehicles | Admin Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="clearfix">
           ...
           <a href="{{url('admin/vehicles/create')}}"  class="form-inline float-right mt--1 d-none d-md-flex">
               <button class="btn btn-info"><i class="fa fa-plus-circle"></i> Create new Vehicle</button>
           </a>

           <!-- <a href="{{url('admin/vehicles/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
             <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create a New Vehicle Owner</button>
         </a> -->
     ...
     <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md">
                    {{Form::open(['url'=>['admin/vehicless'],'method'=>'GET'])}}
                ...
                <div class="col-md">
                    <div class="form-group">
                        {{Form::open(['url'=>['admin/vehicles'],'method'=>'GET'])}}
  ...
  <table class="table table-striped table-hover table-sm table-bordered table-responsive" >
    ...
    <tbody>
        ...
        <tr class="deleteRow">
            ...
            <td style="color: #e91e63;text-decoration :underline; " data-toggle="tooltip" data-placement="top" title="Go to Delivery Rider Panel" class=" clickable-row" data-href="{{ URL::to('service-partner/dashboard/'.$data->id) }}" data-underline>{{$data->vehicle_userid}}  </td>
