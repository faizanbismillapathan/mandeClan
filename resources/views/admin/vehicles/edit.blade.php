...
@section('title',"Update New Vehicle | Admin Mande Clan")
...
<div class="vehicle_form" > 
 ...
 @if(!empty($record_vehicle))
       {!! Form::model($record_vehicle,array('url' => ['admin/vehicles', $record_vehicle->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
...
<hr>
  ...
  <fieldset class="scheduler-border">
  <legend class="scheduler-border">Another Related  Vehicles &nbsp;:</legend>
