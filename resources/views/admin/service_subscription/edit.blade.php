...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Update Service subscription</b></h1>
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/service-subscription', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
       ...
       @endif
           ...
           <div class="form-row">
                 <div class="form-group col-md-4">
                         ...
                         {!!Form::text('service_plan_price',null,array('class'=>'form-control numbersOnly','placeholder'=>'','autocomplete'=>'off','required','minlength'=>'1','maxlength'=>'3')) !!} 
                        </div>
                             <div class="form-group col-md-4">
                          <label for="inputEmail4">Plan Id</label>
                         {!!Form::text('service_plan_id',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','required','readonly')) !!} 
                        </div>
