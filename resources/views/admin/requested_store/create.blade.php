...
@section('title',"Create New Requeste store | Admin Mande Clan")
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Create Requeste store</b></h1>
...
<div class="card-body">
             ...
             {!!Form::open(['url'=>['admin/requested-store'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
  ...
  <legend class="scheduler-border">Store Locations &nbsp;:</legend>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
          ...
          {!!Form::text('store_phone',null,array('class'=>'form-control contact_no_validate','minlength'=>'10' ,'maxlength'=>'13','placeholder'=>'','autocomplete'=>'off')) !!} 
      </div>
