...
@section('title',"All Tickets | Admin Mande Clan")
  ...
  <main class="content">
                    <div class="container-fluid p-0">
                        ...
                        <div class="clearfix">
                            ...
                            {{--  <a href="{{url('admin/tickets/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
                                       <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create a New Tickets</button>
                                    </a> --}}

                            <h1 class="h3 mb-3">Tickets &nbsp;&nbsp;@if(!empty($records))({{$records->total()}})@endif</h1>
                        </div>
                        ...
                        <div class="card">
                                <div class="card-body">
                                        <div class="row">
                                            <div class="col-md">
                                            {{Form::open(['url'=>['admin/tickets'],'method'=>'GET'])}}
                                            
@if(!empty($ticket_names))
                                                {!!Form::select('search',$ticket_names,null,array('class'=>'form-control select2','placeholder'=>'Search','data-toggle'=>'select2','onchange'=>'this.form.submit()')) !!}
@endif
      ...
      {!!Form::text('search',Request::input('search'),array('class'=>'form-control','placeholder'=>'Search by Tickets..','onchange'=>'this.form.submit()','autocomplete'=>'off')) !!}
      ...
      <b id="success_message" style="padding: 8px"></b>
                                    ...
                                    <table class="table table-striped table-hover table-sm table-bordered table-responsive" >
                                        <thead>
                                            <tr>
                                                <th width="10%">Sr.</th>
                                          <th width="30%">Tickets Role</th>

                                                <th width="30%">Tickets Name</th>
...
<input type="checkbox" data-toggle="toggle" data-on="Active" data-off="Deactive" data-onstyle="success" data-offstyle="danger" id="{{$data->id}}" class="checkstatus" onchange="updateToggle({{$data->id}})">
   @endif
                                                ...
                                                <td>                                                    
                                                <a href="{{ URL::to('admin/tickets/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
