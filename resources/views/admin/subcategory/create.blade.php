...
<div class="card-body">
             ...
             {!!Form::open(['url'=>['admin/product-category'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
...
$('#comman_form_id').validate({
     ...
     rules: {
          ...
          remote: {
                    url: "{{url('admin/check_unique_product-category')}}",
                    type: "post",

                    data: {
                        check_product-category: function () {
