...
@section('title',"Edit Assigned Vehicle | Admin Mande Clan")
      ...
      <table class="table table-striped table-hover table-sm table-bordered" >
        ...
        <tbody>
          ...
          <tr class="deleteRow">
           ...
           <!--  <td><button  class="btn btn-danger click_unassign_now" rv_id="{{$data->rv_id}}" rider_id="{{$data->id}}" vehicle_id="{{$vehicle_record->id}}"  rider_u_id="{{$data->rv_user_userid}}">Un Assign</button></td> -->
 <td>
