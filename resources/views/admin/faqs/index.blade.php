...
@section('title',"All Faq's | Admin Mande Clan")
  ...
  <main class="content">
                    <div class="container-fluid p-0">
                        ...
                        <div class="clearfix">
                             ...
                             <a href="{{url('admin/faqs/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
                                       <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create a New Faq's</button>
                                    </a>

                            <h1 class="h3 mb-3">Faqs &nbsp;&nbsp;@if(!empty($records))({{$records->total()}})@endif</h1>
                        </div>
                        ...
                        <div class="card">
                                <div class="card-body">
                                        <div class="row">
                                            <div class="col-md">
                                            {{Form::open(['url'=>['admin/faqs'],'method'=>'GET'])}}
                                            
@if(!empty($faqs))
                        {!!Form::select('search',$faqs,Request::input('search'),array('class'=>'form-control select2','placeholder'=>'Search','data-toggle'=>'select2','onchange'=>'this.form.submit()','id'=>'test_skill')) !!}
      ...
      <b id="success_message" style="padding: 8px"></b>
                                    ...
                                    <table class="table table-striped table-hover table-sm table-bordered" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="deleteRow">
                                                <td>{{$index+1}}</td>   
                                                <td>{{substr(strip_tags($data->question), 0, 300).'....'}}</td>
                                                <td>{{substr(strip_tags($data->answer), 0, 300).'....'}}</td>
                                                <td>
...
<input type="checkbox" data-toggle="toggle" data-on="Active" data-off="Deactive" data-onstyle="success" data-offstyle="danger" id="{{$data->id}}" class="checkstatus" onchange="updateToggle({{$data->id}})">
   @endif
                                                ...
                                                <td>                                                    
                                                <a href="{{ URL::to('admin/faqs/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
