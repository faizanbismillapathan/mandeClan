...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            <a href="{{url('admin/archive-store')}}" style="margin-left: 17px;" class="form-inline float-right mt--1 d-none d-md-flex margin">
...
<div class="card">
    ...
    <div class="card-body password_contact">
       ...
       @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/archive-store', $record->id],'method'=>'PATCH','class'=>'','id' =>'seprate_form_id','files'=>'true')) !!}
...
<fieldset class="scheduler-border">
    ...
    <div class="form-row">
      ...
      <!--  <div class="form-group col-md-4 ">
          ...
          {!!Form::select('store_product_category[]',$product_category,explode(',',$record->store_product_category),array('class'=>'form-control select2 ','placeholder'=>'Select Category','data-toggle'=>'select2','required','multiple')) !!}

      </div> -->

      <div class="form-group col-md-4">
          <label for="inputEmail4">Store Name</label>
          {!!Form::text('store_name',null,array('class'=>'form-control onlyAlphabet','placeholder'=>'','autocomplete'=>'off','required')) !!} 
      </div>
...
<a class="btn" href="{{url('admin/archive-store')}}" style="background-color: #9e9b9b;color: #fff"><i class="fas fa-times"></i>  Cancel</a>
