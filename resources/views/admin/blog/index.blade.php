...
@section('title',"All Blogs | Admin Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="clearfix">
           ...
           <a href="{{url('admin/blog/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
             <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create a New Blog</button>
         </a>

         <h1 class="h3 mb-3">Blogs &nbsp;&nbsp;@if(!empty($records))({{$records->total()}})@endif</h1>
     </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md">
                    ...
                    @if(!empty($blog))
                    {!!Form::select('search',$blog,Request::input('search'),array('class'=>'form-control select2','placeholder'=>'Search','data-toggle'=>'select2','onchange'=>'this.form.submit()','id'=>'test_skill')) !!}


<!--                                                 {!!Form::select('search',$blog,null,array('class'=>'form-control select2','placeholder'=>'Search','data-toggle'=>'select2','onchange'=>'this.form.submit()')) !!}
-->@endif
...
<table class="table table-striped table-hover table-sm table-bordered" >
    ...
    <tbody>
        ...
        <tr class="deleteRow">
            ...
            {{-- <td>{{substr(strip_tags($data->blog_description), 0, 300).'....'}}</td> --}}
            <td>{{$data->author_name}}</td>
{{--             <td><img src="{{asset('public/images/blog_image/'.$data->blog_image)}}" width="50" height="30"></td>
 --}}
            <td>
           ...
           <td>                                                    
            <a href="{{ URL::to('admin/blog/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
