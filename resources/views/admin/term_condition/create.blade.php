...
@section('title',"Create New Term & Conditions | Admin Mande Clan")
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Create Term & Conditions</b></h1>
...
<div class="card-body">
             ...
             {!!Form::open(['url'=>['admin/term-condition'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
...
@endif
                    ...
                    <div class="form-group col-md-8">
                      ...
                      <div class="form-group col-md-12">
                          ...
                          {!! Form::textarea('description',null,['class'=>'form-control textarea', 'rows' => 20, 'cols' => 50,'id'=>'']) !!}
                        </div>
              </div>
