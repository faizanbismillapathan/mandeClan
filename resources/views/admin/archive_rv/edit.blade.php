...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            <a href="{{url('admin/archive-rv')}}" class="form-inline float-right mt--1 d-none d-md-flex">
        ...
        <div class="card">
            ...
            <div class="card-body password_contact">
               @if(!empty($record))
               {!! Form::model($record,array('url' => ['admin/archive-rv', $record->id],'method'=>'PATCH','class'=>'','id' =>'seprate_form_id','files'=>'true')) !!}
...
<a class="btn" href="{{url('admin/archive-rv')}}" style="background-color: #9e9b9b;color: #fff"><i class="fas fa-times"></i>  Cancel</a>
