...
@section('title',"Edit Vehicle List | Admin Mande Clan")
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Update Vehicle List</b></h1>
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/vehicle-type', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
                ...
                <div class="col-md-8">
                  <div class="form-row">
                   ...
                   <div class="form-group col-md-6">
                    ...
                    {!! Form::text('vehicle_unique_id',null,array('class'=>'form-control','readonly'=>'readonly')) !!}
                </div>
           ...
           <div class="form-group author-img-bx">
            ...
            <div class="fileupload fileupload-new" data-provides="fileupload">
                ...
                @if(!empty($record->vehicle_image))
                   <img src="{{ asset('public/images/vehicle_image/'.$record->vehicle_image)}}" alt="dd" />
