...
@section('title',"Store Payout List | Admin Mande Clan")
    ...
    <div class="container-fluid p-0">
        ...
        <div class="card">
            ...
            <div class="table-responsive p-4">
             ...
             {{Form::open(['url'=>['admin/store-payout-list/'.Request::segment(3).'?from_date='.Request::Input('from_date').'&to_date='.Request::Input('to_date')],'method'=>'GET'])}}
...
<div class="col-md">
              <div class="float-right">
                ...
                <a href="{{ url('admin/store-item-wise-payout?from_date='.Request::Input('from_date').'&to_date='.Request::Input('to_date').'&store_id='.$record->id) }}">
...
<a href="{{ url('admin/store-item-wise-pdf-payout/'.$data->id.'?from_date='.Request::Input('from_date').'&to_date='.Request::Input('to_date').'&store_id='.$data->store_id) }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-download mx-1 text-secondar"></i></button></a>
<a href="{{ url('admin/store-item-wise-payout/'.$data->id.'?from_date='.Request::Input('from_date').'&to_date='.Request::Input('to_date').'&store_id='.$data->store_id) }}"><button class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-eye mx-1 text-secondar"></i></button></a>
<a href="{{url('admin/store-item-wise-excel-payout/'.$data->id.'?from_date='.Request::Input('from_date').'&to_date='.Request::Input('to_date').'&store_id='.$data->store_id)}}"><button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-file-excel mx-1 text-secondar"></i></button></a>
