...
@section('title',"All Document | Admin Mande Clan")
  ...
  <main class="content">
                    <div class="container-fluid p-0">
                        ...
                        <div class="clearfix">
                             ...
                             <a href="{{url('admin/document/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
                        ...
                        <div class="card">
                                <div class="card-body">
                                        <div class="row">
                                            <div class="col-md">
                                            {{Form::open(['url'=>['admin/document'],'method'=>'GET'])}}
                                            
@if(!empty($document_names))
                                                {!!Form::select('search',$document_names,null,array('class'=>'form-control select2','placeholder'=>'Search','data-toggle'=>'select2','onchange'=>'this.form.submit()')) !!}
@endif
...
<input type="checkbox" data-toggle="toggle" data-on="Active" data-off="Deactive" data-onstyle="success" data-offstyle="danger" id="{{$data->id}}" class="checkstatus" onchange="updateToggle({{$data->id}})">
   @endif
                                                ...
                                                <td>                                                    
                                                <a href="{{ URL::to('admin/document/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
