...
<main class="content">
    <div class="container-fluid p-0">
        ...
        {{--    <a href="{{url('admin/archive-service/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
             <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create a New Service</button>
         </a>
 --}}
         <h1 class="h3 mb-3">Archive Services&nbsp;&nbsp;@if(!empty($records))({{$records->total()}})@endif</h1>
     </div>

     <div class="card">
        <div class="card-body">
                    {{Form::open(['url'=>['admin/archive-service'],'method'=>'GET'])}}
...
{{-- <td><div class="progress">
 ...
 <button class="btn btn-danger click_disbled_status"  data-toggle="tooltip" data-placement="top" title="Delete"  data="{{$data->id}}">Recover</button>  
           ...
           <td>                                                    
            <a href="{{ URL::to('admin/archive-service/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
...
swal({
  ...
  confirmButtonText: 'Yes, Recover Account it!'
    ...
    $.ajax({
           ...
           url:"{{url('admin/archive-service-recorver')}}",
