...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="clearfix">
           ...
           <a href="{{url('admin/archive-customer/create')}}" class="form-inline float-right mt--1 d-none d-md-flex">
     ...
     <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md">
                    {{Form::open(['url'=>['admin/archive-customer'],'method'=>'GET'])}}
  ...
  <table class="table table-striped table-hover table-sm table-bordered table-responsive" >
    ...
    <tbody>
        ...
        <tr class="deleteRow">
           ...
           <td>                                                    
            <a href="{{ URL::to('admin/archive-customer/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
...
swal({
  ...
  confirmButtonText: 'Yes, Recover Account it!'
    ...
    $.ajax({
           ...
           url:"{{url('admin/archive-customer-recorver')}}",
