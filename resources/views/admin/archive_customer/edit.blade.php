...
@section('title',"Edit Customer | Admin Mande Clan")
...
<div class="clearfix">
    <a href="{{url('admin/archive-customer')}}" class="form-inline float-right mt--1 d-none d-md-flex">
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
    </a>
        <h1 class="h3 mb-3"><b>Update Customer</b></h1>
...
<div class="card-body password_contact">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/archive-customer', $record->id],'method'=>'PATCH','class'=>'','id' =>'seprate_form_id','files'=>'true')) !!}
...
<a class="btn" href="{{url('admin/archive-customer')}}" style="background-color: #9e9b9b;color: #fff"><i class="fas fa-times"></i>  Cancel</a>
