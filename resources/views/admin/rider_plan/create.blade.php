...
@section('title',"Create New Rider Plan | Admin Mande Clan")
<!-- ................custom css................. -->
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Create Rider Plan</b></h1>
...
<div class="card-body">
             ...
             {!!Form::open(['url'=>['admin/rider-plan'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
          ...
          <div class="form-row">
                 <div class="form-group col-md-4">
                         ...
                         {!!Form::text('rider_plan_id',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','required')) !!} 
                        </div>
