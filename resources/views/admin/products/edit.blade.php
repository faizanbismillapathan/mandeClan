...
@section('title',"Edit Products | admin Mande Clan")
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/products', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
  ...
  <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    <label for="inputEmail6">Product Category</label>
                     {!!Form::select('product_category',$product_categories,null,array('class'=>'form-control select2 product_selector','placeholder'=>'','data-toggle'=>'select2','required')) !!}
