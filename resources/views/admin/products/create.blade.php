...
@section('title',"Create New Products | admin Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            <a href="{{url('admin/products')}}" class="form-inline float-right mt--1 d-none d-md-flex">
        ...
        <div class="card">
            ...
            <div class="card-body">
             ...
             {!!Form::open(['url'=>['admin/products'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
...
<div class="row">
  ...
  <div class="form-group col-md-6">
                    <label for="inputEmail6">Store Category</label>     
                    {!!Form::select('store_category',$categories,null,array('class'=>'form-control select2 selector','placeholder'=>'','data-toggle'=>'select2','required')) !!}
                ...
                <div class="form-group col-md-6">
                    <label for="inputEmail6">Product Category</label>
                     {!!Form::select('product_category',[],null,array('class'=>'form-control select2 product_selector','placeholder'=>'','data-toggle'=>'select2','required')) !!}
 ...
 <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    <label for="inputEmail6">Product Brand</label>                                                                 {!!Form::select('product_brand',[],null,array('class'=>'form-control select2 ','placeholder'=>'','data-toggle'=>'select2')) !!}
...
<a class="btn" href="{{url('admin/products')}}" style="background-color: #9e9b9b;color: #fff"><i class="fas fa-times"></i>  Cancel</a>
...
console.log(error)
        ...
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                 ...
                 $.ajax({
          url: "{{url('admin/append_product_subcategory')}}",
          type: "post",
          data: {id:subcatID},
                    dataType: "json",
                    success:function(data) {
