...
@section('title',"All seller-product-items | Admin Mande Clan")
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    {{Form::open(['url'=>['admin/seller-product-items'],'method'=>'GET'])}}
      ...
      <b id="success_message" style="padding: 8px"></b>
        ...
        <tbody>
            ...
            <td> {{round($selling_price,2)}} $</td>
             ...
             <td>                                                    
                <a href="{{ URL::to('seller/seller-product-items/'.$data->id.'/edit') }}"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
