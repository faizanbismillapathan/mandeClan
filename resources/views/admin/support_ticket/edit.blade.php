...
@section('title',"Create New Support Ticket   | Admin Mande Clan")
...
<div class="clearfix">
<a href="{{url('admin/support-tickets')}}" class="form-inline float-right mt--1 d-none d-md-flex">
...
{!!Form::open(['url'=>['admin/support-tickets'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-success" style="text-align:center;">
                                    Your support ticket status is &nbsp;  <strong class="status_update"> {{$record->status}} </strong>  &nbsp; , reply below for more inquiry.
                                </div>
                            </div>
                            <div class="col-md-12">
...
<div class="panel-body message-form" style="display: block;">
 ...
 {!! Form::open(array('url' => 'admin/reply-support-ticket','files'=>'true','method'=>'POST', 'class'=>'new-support-ticket')) !!}
...
<input type="hidden" name="name" value="Support Team">
            </div>
          ...
          <div class="form-group mt-2 row">
            <div class="col-md-4">
              <label>Change Status:</label>
               {!!Form::select('status',['Closed'=>'Closed','Solved'=>'Solved','Open'=>'Open'],$record->status,array('class'=>'form-control selector select2','placeholder'=>'Select','data-toggle'=>'select2','autocomplete'=>'off','required','id'=>$record->id)) !!}
            </div>
    ...
    $(".onlyopen").show();
        ...
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                 ...
                 $.ajax({
          url: "{{url('admin/ticket_status_update')}}",
          type: "post",
