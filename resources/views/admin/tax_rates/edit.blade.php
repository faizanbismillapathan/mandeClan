...
@section('title',"Edit Tax Rate | Admin Mande Clan")
...
<div class="clearfix">
    ...
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
        ...
        <h1 class="h3 mb-3"><b>Update Tax Rate</b></h1>
...
<div class="card-body">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['admin/tax-rate', $record->id],'method'=>'PATCH','class'=>'','id' =>'comman_form_id','files'=>'true')) !!}
