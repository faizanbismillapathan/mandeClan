...
@section('title',"Create New Zones | Admin Mande Clan")
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="clearfix">
            ...
            <h1 class="h3 mb-3"><b>Create Zones</b></h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
               ...
               {!!Form::open(['url'=>['admin/zones'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
        ...
        <div class="form-row">
         <div class="form-group col-md-6">
            ...
            {!!Form::select('zone_state[]',[],null,array('class'=>'form-control select2','placeholder'=>'Select State','data-toggle'=>'select2','required','multiple','id'=>'upload_id')) !!}
