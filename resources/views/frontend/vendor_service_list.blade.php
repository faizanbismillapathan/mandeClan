...
<div class="padding shop-list">
	...
	<div class="container-fluid">
        ...
        <div class="col-md-8 padding0">
          <p class="vendor-title">{{$category->category_name}} Services Vendor in {{Session::get('locality_name')}}</p>
            ...
            <div class="input-group-prepend">
              <span class="input-group-text">
                <img src="{{url('public/frontend/img/searching.png')}}">
                        ...
                        {!!Form::text('search',\Request::input('search'),array('class'=>'form-control','placeholder'=>'Search Service from '.Session::get('locality_name').'...','onkeyup'=>'this.form.submit()')) !!}
      ...
      {{Form::close()}}
		...
		<div class="row whishlist">
            ...
            <div class="card card1" id="service3">
...
service_id="{{$data['id']}}" service_user_id="{{$data['user_id']}}"></i>
...
@endif--}}
            ...
            <h5 class="shop-name shop-name3">{{substr($data['service_name'],0,31)}}
...
@endif
            ...
            <span class="badge badge-warning"><i class="fas fa-star"></i> {{$data['service_rating']}}</span>
            </div>
            </div>
            </div>
