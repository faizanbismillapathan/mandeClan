            ...
            $(".selectpicker").change(function() {
                ...
                if ($('.selectpicker option').is(":selected")) {
                    ...
                    if (check.length != 0) {
                        ...
                        $(this).parent().parent().parent().children('label').css({
                            "top": "2.3rem",
                            "font-size": "14px"
                        })
                    }
    ...
    <div style="background: beige;" class="row margin0 login-sign-forg zar_new_forg">
        <div class="col-md-6 padding0" style="margin: 0 auto;padding:50px 0px 40px 0px;">
            <div class="row margin0" style="border:1px solid #ccc">
                ...
                <!--  <div class="img">-->
                <!--  <img src="{{ asset('/img/mandeclan_black1.png') }}">-->
                <!--  </div>-->
                <!--</div>-->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter your name"
                                            name="store_owner_name" required="required" autocomplete="off"
                                            value="{{ Session::get('store_owner_name') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Store Name</label>
                                        <input type="text" class="form-control" placeholder="Enter your store name"
                                            name="store_name" required="required" autocomplete="off"
                                            value="{{ Session::get('store_name') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" class="form-control emailfull" placeholder="Enter your email"
                                            name="store_owner_email" id="store_owner_emailss" required="required"
                                            autocomplete="off" value="{{ Session::get('store_owner_email') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            {!! Form::text('store_owner_mobile', str_replace(' ', '', Session::get('store_owner_mobile')), [
                                                'class' => 'form-control mobile_input numbersOnly',
                                                'placeholder' => 'Mobile Number',
                                                'id' => 'store_owner_mobiles',
                                                'minlength' => '10',
                                                'maxlength' => '10',
                                            ]) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="custom-control custom-radio">
                                                @if (!empty(Session::get('store_owner_gendor')))
                                                    <input type="radio" name="store_owner_gendor"
                                                        class="custom-control-input " value="Male"
                                                        {{ Session::get('store_owner_gendor') == 'Male' ? 'checked' : '' }}>
                                                @else
                                                    <input type="radio" name="store_owner_gendor"
                                        ...
                                        <div class="col-md-6"> <label class="custom-control custom-radio">
                                                <input type="radio" name="store_owner_gendor"
                                                    ...
                                                    {{ Session::get('store_owner_gendor') == 'Female' ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-md-7">
                                    ...
                                    <div class="row">
                                            ...
                                            <label class="custom-control custom-radio">
                                                @if (!empty(Session::get('type')))
                                                    <input type="radio" name="type"
                                                        class="custom-control-input service_type_cls" value="Store"
                                                        {{ Session::get('type') == 'Store' ? 'checked' : '' }}>
                                                @else
                                                    <input type="radio" name="type"
                                                        class="custom-control-input service_type_cls" value="Store"
                                                        checked>
                                        ...
                                        <div class="col-md-6"> <label class="custom-control custom-radio">
                                                ...
                                                <input type="radio" name="type"
                                                    class="custom-control-input service_type_cls" value="Service"
                                                    {{ Session::get('type') == 'Service' ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-md-6 select_store_category">
                                    <div class="multiselect-option">
                                        <div class="form-group">
                                            <label class="">Select Store Category</label>
                                            {!! Form::select('store_category', $categories, Session::get('store_category'), [
                                ...
                                <div class="form-group col-md-6 select_service_category" style="display:none">
                                    <div class="multiselect-option">
                                        <div class="form-group">
                                            <label class="">Select Service Category</label> <br>
                                            {!! Form::select('service_category', $servic_categories, Session::get('service_category'), [
                                                'class' => 'form-control select2  ',
                                                'placeholder' => 'Select Category',
                                                'data-toggle' => 'select2',
                                            ]) !!}
                                ...
                                <div class="form-group col-md-6">
                                    <div class="multiselect-option">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('store_city', $countries, Session::get('store_city'), [
                                                'class' => 'form-control select2 city_selector',
                                ...
                                <div class="form-group col-md-6">
                                    <div class="multiselect-option">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('store_locality', $localities, Session::get('store_locality'), [
                                                'class' => 'form-control locality_selector123 select2',
                                ...
                                <div class="form-group col-md-6">
                                    <label for="inputPassword6">Pin Code</label>
                                    {!! Form::text('store_pincode', Session::get('store_pincode'), [
                                        'class' => 'form-control',
                                        'placeholder' => '',
                                        'autocomplete' => 'off',
                                        'required',
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="">Website</label>
                                        {!! Form::url('store_website', Session::get('store_website'), [
                                            'class' => 'form-control',
                                            'placeholder' => '',
                                            'autocomplete' => 'off',
                                        ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('store_password', Session::get('store_password'), [
                                            'class' => 'form-control',
                                            'placeholder' => '',
                                            'autocomplete' => 'off',
                                        ]) !!}
                            ...
                            <form id="otp_form" class="otp_form_cls" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <h6 class="change_contact_cls"><b
                                                class="store_owner_mobile">{{ Session::get('store_owner_mobile') }}</b>
                                        </h6>
                                ...
                                <div class="input-grp otp_show hide otp_ids">
                                    <div class="input-group input_grp">
                                        ...
                                        <input type="text" class="form-control numbersOnly" placeholder="Enter OTP "
                                            required="required" id="otp" name="otp" maxlength="4"
                                            minlength="4">
                                        <div class="input-group-append">
                                            ...
                                            <span class="input-group-text hide center" id="resend_otps">
                                                <p id="resend_otps_submit " style="cursor: pointer;"
                                ...
                                <button class="btn-raised btn btn-success custom-cheryred ContinueOtpBtn mt-3"
                                    id="td_id">Verify OTP</button>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="center footer-div">
                                        <p>Already Register ? <a href="{{ url('vendor-login') }}"
                        ...
                        remote: {
                            ...
                            data: {
                                check_store_owner_mobile: function() {
                                    ...
                                    $(".store_owner_mobile").text("+" + $("#phone3").val() + $(
                                        "#store_owner_mobiles").val())
                                    console.log("+" + $("#phone3").val() + $("#store_owner_mobiles")
                                        .val())
            ...
            if (stateID) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('select[name="store_locality"]').append('<option value="' + '' + '">' +
                            'None' + '</option>');
                        $.each(data, function(key, value) {
                            $('select[name="store_locality"]').append('<option value="' + key +
                                '">' + value + '</option>');
                        });
                    }
