...
<!--  -->                
        ...
        <!-- content -->
<!--  -->
<div class="padding terms-conditio faqs">
	<div class="container-fluid">
        
		<h4 class="title-heading">Frequently Ask Question</h4>
        @if(!empty($records))
        @foreach($records as $index=>$data)
        <div class="ques-ans-div">
        	<p class="p1"><b>Ques. : {{$index+1}}</b> {{$data->question}}</p>
            <p class="p2"><b>Ans: </b> {!!$data->answer!!}</p>
        </div>
        @endforeach
