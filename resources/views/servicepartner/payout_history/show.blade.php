...
@section('title',"All Payout History Detail | Service Partner Mande Clan")
...
<main class="content profile-order-history">
    <div class="container-fluid p-0">
        ...
        <div class="clearfix">
 <a href="{{url('service-partner/payout-history')}}" class="form-inline float-right mt--1 d-none d-md-flex">
    <button class="btn btn-info"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp; Back</button>
    </a>
            <h1 class="h3 mb-3">Payout History Detail &nbsp;&nbsp;@if(!empty($records))({{$records->total()}})@endif</h1>
        </div>
