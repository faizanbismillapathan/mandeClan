...
@section('title',"Edit Rider / Vehicle | service-partner Mande Clan")
...
<div class="card-body password_contact">
     @if(!empty($record))
       {!! Form::model($record,array('url' => ['service-partner/profile', $record->id],'method'=>'PATCH','class'=>'','id' =>'seprate_form_id','files'=>'true')) !!}
       ...
       @endif
            ...
            {!! Form::text('rv_user_userid',null,array('class'=>'form-control','readonly'=>'readonly')) !!}
                         ...
                         {{--  <div class="form-group col-md-6">
                              ...
                              {!!Form::text('rv_user_mobile',null,array('class'=>'form-control','placeholder'=>'','autocomplete'=>'off','required')) !!} 
                          </div>
 --}}
                          <div class="form-group col-md-6">
                   ...
                   <div class="row">
                       <div class="col-md-12">
                          <button type="button" class="btn btn-secondary" style="padding: 0px; background-color: #fff;"><span class="btn btn-default btn-file">
                            ...
                            {{ Form::file('rv_user_img',null, ['class' => 'form-control']) }}</span>
...
<fieldset class="scheduler-border">
  ...
  <div class="form-row">
                         ...
                         <div class="form-group col-md-4">
                          <div class="row">
                            <div class="col-md-4"><b>login Email</b>
                            </div>
                            <div class="col-md-1"><b>:</b></div>
