...
@section('title',"Create New Assigned Vehicle | Service Partner Mande Clan")
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group pull-right">
          {{Form::open(['url'=>['service-partner/assigned-vehicle/'.$vehicle_record->id],'method'=>'GET'])}}
      ...
      <table class="table table-striped table-hover table-sm table-bordered" >
        ...
        <tbody>
          ...
          <tr class="deleteRow">
            ...
            <td><a href="{{url('service-partner/delivery-rider/'.$data->rv_id.'/edit')}}">{{$data->rv_user_userid}}</a></td>   
