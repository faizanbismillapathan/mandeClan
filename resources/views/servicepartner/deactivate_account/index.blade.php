...
@section('title',"All Subscriptions | service partner  Mande Clan")
  ...
  <div class="card-padding">
    <div class="account-deactivate">
        <div>
            ...
            <p class="center">Please remember that by cancelling your account, you will no longer be able to benefit from our services. If you have any questions, please contact our Customer Service Departments</p>
      ...
      <!--  -->
            ...
            {!!Form::open(['url'=>['service-partner/deactivate-account'],'files' => true, 'class' => ' form-bordered form-row-stripped SendOtpFunction','id' =>'comman_form_id'])!!}
            ...
            <label class="custom-control custom-radio">
                {{ Form::radio('status_reason', 'I am not satisfied with your Customer Service' , false,array('class'=>'custom-control-input radio_cls')) }}

                <span class="custom-control-label"> I am not satisfied with your Customer Service</span>
            </label>  
            ...
            <label class="custom-control custom-radio">
                {{ Form::radio('status_reason', 'I don not need this service' , false,array('class'=>'custom-control-input radio_cls')) }}

                <span class="custom-control-label"> I don not need this service</span>
            </label>  
            <label class="custom-control custom-radio">
...
$(".ContinueBtn").prop('disabled',true)
    ...
    $.ajax({
      url: "{{ url('service-partner/deactivate-account') }}",
      type:"POST",
...
if (otp) {
    $.ajax({
      url: "{{ url('service-partner/verify_and_deactivate') }}",
      type:"POST",
