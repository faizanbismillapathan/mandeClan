...
@section('title',"Create New Support Ticket   | Service-partner Mande Clan")
...
{!!Form::open(['url'=>['service-partner/support-ticket'],'files' => true, 'class' => ' form-bordered form-row-stripped','id' =>'comman_form_id'])!!}
