...
@section('title',"All Support Tickit | Service-partner Mande Clan")
...
<div class="panel-body message-form" style="display: block;">
 ...
 {!! Form::open(array('url' => 'service-partner/reply-support-ticket','files'=>'true','method'=>'POST', 'class'=>'new-support-ticket')) !!}
