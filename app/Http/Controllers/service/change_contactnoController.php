...
$record=DB::table('users')->where('id',$this->user_id)->first();
        ...
        return view('service.change_contactno.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('service.change_contactno.create',compact('record'));
    }
     ...
     */
      ...
      public function verify_service_mobile(Request $request)
    {
...
return json_encode($mobile);
    ...
    public function show1($id)
    {
        ...
        return view('service.change_contactno.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('service.change_contactno.edit',compact('record'));
...
return Redirect::to('service/change-contactno')->with($notification);
    }
