...
class today_earningController extends Controller
{
    /**
...
return view('servicepartner.today_earning.index');
    ...
    public function create()
    {
       ...
       return view('servicepartner.today_earning.create',compact('record'));
   }
    ...
    public function store(Request $request)
    {
       ...
       return Redirect::to('servicepartner/today_earning')->with($notification);
    ...
    public function show($id)
    {
       ...
       return view('servicepartner.today_earning.show',compact('view'));
   }
    ...
    public function edit($id)
    {
        ...
        return view('servicepartner.today_earning.edit',compact('record'));
...
return Redirect::to('servicepartner/today_earning')->with($notification);
   ...
   public function status_update(Request $request){
       ...
       if($record['status']=='Active'){
         $updatevender=\DB::table('today_earning')->where('id',$request->user_id)
         ->update([
            'status' => 'Deactive',
        ]);
         return json_encode('Deactive');
     } else {
      $updateuser=\DB::table('today_earning')->where('id',$request->user_id)
      ->update([
        'status' => 'Active',
