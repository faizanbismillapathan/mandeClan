...
class live_gps_locationController extends Controller
{
    /**
...
return view('servicepartner.live_gps_location.index');
    ...
    public function create()
    {
       ...
       return view('servicepartner.live_gps_location.create',compact('record'));
   }
    ...
    public function store(Request $request)
    {
       ...
       return Redirect::to('servicepartner/live_gps_location')->with($notification);
    ...
    public function show($id)
    {
       ...
       return view('servicepartner.live_gps_location.show',compact('view'));
   }
    ...
    public function edit($id)
    {
        ...
        return view('servicepartner.live_gps_location.edit',compact('record'));
...
return Redirect::to('servicepartner/live_gps_location')->with($notification);
   ...
   public function status_update(Request $request){
       ...
       if($record['status']=='Active'){
         $updatevender=\DB::table('live_gps_location')->where('id',$request->user_id)
         ->update([
            'status' => 'Deactive',
        ]);
         return json_encode('Deactive');
     } else {
      $updateuser=\DB::table('live_gps_location')->where('id',$request->user_id)
      ->update([
        'status' => 'Active',
