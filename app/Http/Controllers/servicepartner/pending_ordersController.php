...
return view('servicepartner.pending_orders.index');
    ...
    public function create()
    {
       ...
       return view('servicepartner.pending_orders.create',compact('record'));
   }
    ...
    public function store(Request $request)
    {
       ...
       return Redirect::to('servicepartner/pending_orders')->with($notification);
    ...
    public function show($id)
    {
       ...
       return view('servicepartner.pending_orders.show',compact('view'));
   }
    ...
    public function edit($id)
    {
        ...
        return view('servicepartner.pending_orders.edit',compact('record'));
