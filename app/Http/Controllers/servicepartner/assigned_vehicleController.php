...
->orWhere('vehicle_masters.vehicle_name','like','%' . $term . '%');
     ...
     $records= $records
     ->where('assign_rv_id',$this->id)
     ->paginate(25);

// dd($records);

     return view('servicepartner.assigned_vehicle.index',compact('records'));
    ...
    public function create()
    {
       ...
       return view('servicepartner.assigned_vehicle.create',compact('record'));
   }
    ...
    public function store(Request $request)
    {
       ...
       return Redirect::to('servicepartner/assigned_vehicle')->with($notification);
...
// dd($license->vehicle_license_name);
      ...
      return view('servicepartner.assigned_vehicle.create',compact('vehicle_record','rider_records'));
...
// dd($rider_records);
      return view('servicepartner.assigned_vehicle.edit',compact('vehicle_record','rider_records'));
