...
// dd($mailstatus);
  ...
  return view('frontend.vendor-signup',compact('categories','cities','servic_categories','localities'));
}
...
if ($err) {
    ...
    return ['status'=>'success','owner_mobile'=>$owner_mobile,'owner_email'=>$owner_email,'owner_name'=>$owner_name,'store_name'=>$store_name,'category'=>$category,'store_city'=>$store_city,'store_owner_gendor'=>$store_owner_gendor,'type'=>$type,'service_category'=>$service_category,'store_website'=>$store_website,'store_locality'=>$store_locality,'store_pincode'=>$store_pincode,'store_password'=>$store_password];
    // return $data;
}
