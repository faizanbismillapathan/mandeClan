...
// return $response;
    ...
    if ($new_response['message']=='OTP verified success' || $new_response['message']=='Mobile no. already verified' || $new_response['message']=='Mobile no. not found') {
...
public function service_item_form_view(Request $request)
{
    ...
    $services=DB::table('services')
    ->where('id',$request->id)->select('id','service_category','service_subcategory')->first();
    ...
    return view('service.services.create',compact('categories','warranty','keydata','services','brands','record'));
...
public function service_add_new_delete(Request $request)
{
