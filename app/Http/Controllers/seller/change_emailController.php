...
$record=DB::table('users')->where('id',$this->user_id)->first();
        ...
        return view('seller.change_email.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('seller.change_email.create',compact('record'));
    }
...
return Redirect::back()->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('seller.change_email.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('seller.change_email.edit',compact('record'));
...
return Redirect::to('seller/change-email')->with($notification);
    }
