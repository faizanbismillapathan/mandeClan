...
return view('seller.invoice_setting.index');
    ...
    public function create()
    {
         ...
         return view('seller.invoice_setting.create',compact('record'));
    }
...
return Redirect::to('seller/invoice-setting')->with($notification);
    ...
    public function show($id)
    {
        ...
        return view('seller.invoice_setting.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = user::find($id);         
         ...
         return view('seller.invoice_setting.edit',compact('record'));
