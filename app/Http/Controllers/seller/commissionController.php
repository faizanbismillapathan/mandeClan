...
//         $records=DB::table('commission')->orderBy('id','desc');
...
//  $commission = array();
// foreach($use as $user) {
// $commission[$user->order_name] = $user->order_name;
// }
...
return view('seller.commission.index');
    ...
    public function create()
    {
         ...
         return view('seller.commission.create',compact('record'));
    }
...
return Redirect::to('seller/invoice-setting')->with($notification);
    ...
    public function show($id)
    {
        ...
        return view('seller.commission.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = user::find($id);         
         ...
         return view('seller.commission.edit',compact('record'));
...
return Redirect::to('seller/invoice-setting')->with($notification);
    ...
    public function destroy(Request $request)
    {
         ...
         $commission = order::find($request->id);
          $commission->delete();
     ...
     public function status_update(Request $request){
         ...
         $record=order::find($request->user_id);
          ...
          if($record['status']=='Active'){
               $updatevender=\DB::table('commission')->where('id',$request->user_id)
                              ->update([
                                'status' => 'Deactive',
                                 ]);
            return json_encode('Deactive');
           } else {
              $updateuser=\DB::table('commission')->where('id',$request->user_id)
                              ->update([
                                'status' => 'Active',
