...
return view('seller.products.index',compact('records','products','checks'));
...
->where('id',$this->id)->select('id','store_category','store_product_category')->first();
...
for ($warranty_exp=1; $warranty_exp <= 12; $warranty_exp++) $warranty[$warranty_exp] = $warranty_exp;
         ...
         return view('seller.products.create',compact('categories','warranty','keydata','brands'));
    }
...
return Redirect::to('seller/products')->with($notification);
    ...
    public function show($id)
    {
        ...
        return view('seller.products.show',compact('view'));
    }
...
for ($warranty_exp=1; $warranty_exp <= 12; $warranty_exp++) $warranty[$warranty_exp] = $warranty_exp;
         ...
         return view('seller.products.edit',compact('record','categories','warranty','brands','subcategories','brands','record1'));
