...
if (!empty($allow_to_change)) {
  ...
  $allows='Yes';
        ...
        return view('seller.change_password.index',compact('allows','record'));
    }
    ...
    public function show($id)
    {
        ...
        return view('seller.change_password.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('seller.change_password.create',compact('record'));
    }
...
return Redirect::to('seller/change-password')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('seller.change_password.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('seller.change_password.edit',compact('record'));
