...
class returned_ordersController extends Controller
{
    /**
...
//         $records=DB::table('returned_orders')->orderBy('id','desc');
...
// foreach($use as $user) {
// $returned_orders[$user->order_name] = $user->order_name;
// }
...
return view('seller.returned_orders.index');
    ...
    public function create()
    {
         ...
         return view('seller.returned_orders.create',compact('record'));
    }
    ...
    'order_name'=>$request->input('order_name'),
         ...
         $returned_orders = new returned_orders($data);
         $returned_orders->save();
...
return Redirect::to('seller/returned-orders')->with($notification);
    ...
    public function show($id)
    {
        ...
        return view('seller.returned_orders.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = user::find($id);         
         ...
         return view('seller.returned_orders.edit',compact('record'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $returned_orders = order::find($id); 

   $data = array(
    'order_name'=>$request->input('order_name'),
    
);
         $returned_orders->update($data);
...
return Redirect::to('seller/returned-orders')->with($notification);
    ...
    public function destroy(Request $request)
    {
         ...
         $returned_orders = order::find($request->id);
     ...
     public function status_update(Request $request){
         ...
         $record=order::find($request->user_id);
          ...
          if($record['status']=='Active'){
               $updatevender=\DB::table('returned_orders')->where('id',$request->user_id)
                              ->update([
                                'status' => 'Deactive',
                                 ]);
            return json_encode('Deactive');
           } else {
              $updateuser=\DB::table('returned_orders')->where('id',$request->user_id)
                              ->update([
                                'status' => 'Active',
