...
class product_itemsController extends Controller
{
    /**
...
->where('product_items.store_id',$this->id)
->paginate(100);
...
// dd($percentage);
        ...
        return view('seller.product_items.view',compact('records'));
...
// dd($keydata);
        return view('seller.product_items.index',compact('record','records','attributs','dynamics','record_edit','keydata'));
    }
...
$record=DB::table('products')
  ...
  return view('seller.product_items.create',compact('records','record'));
...
->leftjoin('product_subcategories','product_subcategories.id','products.product_subcategory')
->select('product_items.*','products.product_name','products.product_cover_photo',
'products.product_name','product_categories.product_category','product_subcategories.product_subcategory','product_items.product_id')
->first();
...
// dd($records);
        return view('seller.product_items.edit',compact('record','records'));
...
// dd($array_combine);
         ...
         $keydata = ''.$Y.'M'.mt_rand(10,100).$key;
...
// $sss11[]=$keys;
            ...
            $Y = date('ys');
         $keydata = ''.$Y.'M'.mt_rand(10,100).$keys;
