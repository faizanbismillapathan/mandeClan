...
$q
    ...
    ->orWhere('message','like','%' . $term . '%');
        ...
        return view('seller.support_ticket.index',compact('records'));
    }
    ...
    public function show($id)
    {
        ...
        return view('seller.support_ticket.index');
    }
...
// dd($tickets);
         return view('seller.support_ticket.create',compact('tickets'));
    }
...
return Redirect::to('seller/support-ticket')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('seller.support_ticket.show',compact('view'));
    }
...
// dd($record);
        return view('seller.support_ticket.view',compact('records','record'));
 ...
 $tickets = DB::table('tickets')  
         ...
         return view('seller.support_ticket.edit',compact('record','tickets'));
