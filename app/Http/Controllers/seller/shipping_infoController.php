...
class shipping_infoController extends Controller
{
    /**
...
//         $records=DB::table('shipping_info')->orderBy('id','desc');
...
//  $shipping_info = array();
// foreach($use as $user) {
// $shipping_info[$user->order_name] = $user->order_name;
// }
...
return view('seller.shipping_info.index');
    ...
    public function create()
    {
         ...
         return view('seller.shipping_info.create',compact('record'));
    }
    ...
    'order_name'=>$request->input('order_name'),
         ...
         $shipping_info = new shipping_info($data);
         $shipping_info->save();
...
return Redirect::to('seller/invoice-setting')->with($notification);
    ...
    public function show($id)
    {
        ...
        return view('seller.shipping_info.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = user::find($id);         
         ...
         return view('seller.shipping_info.edit',compact('record'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $shipping_info = order::find($id); 

   $data = array(
    'order_name'=>$request->input('order_name'),
    
);
         $shipping_info->update($data);
...
return Redirect::to('seller/invoice-setting')->with($notification);
    ...
    public function destroy(Request $request)
    {
         ...
         $shipping_info = order::find($request->id);
     ...
     public function status_update(Request $request){
         ...
         $record=order::find($request->user_id);
          ...
          if($record['status']=='Active'){
               $updatevender=\DB::table('shipping_info')->where('id',$request->user_id)
                              ->update([
                                'status' => 'Deactive',
                                 ]);
            return json_encode('Deactive');
           } else {
              $updateuser=\DB::table('shipping_info')->where('id',$request->user_id)
                              ->update([
                                'status' => 'Active',
