...
$this->user_id=$customer_id->user_id;  
 ...
 $this->user_id=session::get('customer_user_id');
    ...
    public function index()
    {
        ...
        return view('customer.shipped.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('customer.shipped.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('customer.shipped.create',compact('record'));
    }
...
return Redirect::to('customer/shipped')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.shipped.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('customer.shipped.edit',compact('record'));
