...
$this->user_id=$customer_id->user_id;  
 ...
 $this->user_id=session::get('customer_user_id');
    ...
    public function index()
    {
        ...
        return view('customer.cancelled.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('customer.cancelled.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('customer.cancelled.create',compact('record'));
    }
...
return Redirect::to('customer/cancelled')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.cancelled.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('customer.cancelled.edit',compact('record'));
