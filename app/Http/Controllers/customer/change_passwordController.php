...
$this->user_id=$customer_id->user_id;  
 ...
 $this->user_id=session::get('customer_user_id');
    ...
    public function index()
    {
        ...
        return view('customer.change_password.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('customer.change_password.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('customer.change_password.create',compact('record'));
    }
...
return Redirect::to('customer/change_password')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.change_password.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('customer.change_password.edit',compact('record'));
