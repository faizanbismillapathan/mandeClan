...
$this->user_id=$customer_id->user_id;  
 ...
 $this->user_id=session::get('customer_user_id');
    ...
    public function show($id)
    {
        ...
        return view('customer.wallet.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('customer.wallet.create',compact('record'));
    }
...
return Redirect::to('customer/wallet')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.wallet.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('customer.wallet.edit',compact('record'));
