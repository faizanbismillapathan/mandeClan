...
'delivery_time'=>$data->delivery_time,
        ...
        return view('customer.order_history.index',compact('records','record'));
    }
...
'order_status_date'=>$this->order_status_date($data->id),
        ...
        return view('customer.order_history.cancelled',compact('records','record'));
    }
...
// dd($id);
// return view('customer.order_history.order_detail');
 


return view('customer.order_history.order_detail',compact('order_items','order','addressBook'));
  ...
  public function create()
    {
         ...
         return view('customer.order_history.create',compact('record'));
    }
...
return Redirect::to('customer/my-orders')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.order_history.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('customer.order_history.edit',compact('record'));
