...
$this->user_id=$customer_id->user_id;  
 ...
 $this->user_id=session::get('customer_user_id');
    ...
    public function index()
    {
        ...
        return view('customer.delivered.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('customer.delivered.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('customer.delivered.create',compact('record'));
    }
...
return Redirect::to('customer/delivered')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.delivered.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('customer.delivered.edit',compact('record'));
