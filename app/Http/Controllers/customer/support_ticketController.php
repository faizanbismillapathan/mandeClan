...
$q
    ...
    ->orWhere('vendor_email','like','%' . $term . '%')
    ...
    ->orWhere('message','like','%' . $term . '%');
        ...
        return view('customer.support_ticket.index',compact('records'));
    }
    ...
    public function show($id)
    {
        ...
        return view('customer.support_ticket.index');
    }
...
// dd($tickets);
         return view('customer.support_ticket.create',compact('tickets'));
    }
...
return Redirect::to('customer/support-ticket')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.support_ticket.show',compact('view'));
    }
...
// dd($record);
        return view('customer.support_ticket.view',compact('records','record'));
 ...
 $tickets = DB::table('tickets')  
         ...
         return view('customer.support_ticket.edit',compact('record','tickets'));
