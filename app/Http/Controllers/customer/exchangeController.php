...
$this->user_id=$customer_id->user_id;  
 ...
 $this->user_id=session::get('customer_user_id');
    ...
    public function index()
    {
        ...
        return view('customer.exchange.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('customer.exchange.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('customer.exchange.create',compact('record'));
    }
...
return Redirect::to('customer/exchange')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.exchange.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('customer.exchange.edit',compact('record'));
