...
$this->user_id=$customer_id->user_id;  
 ...
 $this->user_id=session::get('customer_user_id');
    ...
    public function show($id)
    {
        ...
        return view('customer.return.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('customer.return.create',compact('record'));
    }
...
return Redirect::to('customer/return')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.return.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('customer.return.edit',compact('record'));
     ...
     public function status_update(Request $request){
         ...
         $record=role::find($request->user_id);
          ...
          if($record['status']=='Active'){
               $updatevender=\DB::table('return')->where('id',$request->user_id)
                              ->update([
                                'status' => 'Deactive',
                                 ]);
            return json_encode('Deactive');
           } else {
              $updateuser=\DB::table('return')->where('id',$request->user_id)
                              ->update([
                                'status' => 'Active',
