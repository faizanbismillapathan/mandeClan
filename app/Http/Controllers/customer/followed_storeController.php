...
class followed_storeController extends Controller
{
    /**
...
$this->user_id=$customer_id->user_id;  
 ...
 $this->user_id=session::get('customer_user_id');
    ...
    public function index()
    {
        ...
        return view('customer.followed_store.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('customer.followed_store.index',compact('record'));
    }
  ...
  public function create()
    {
         ...
         return view('customer.followed_store.create',compact('record'));
    }
...
return Redirect::to('customer/followed_store')->with($notification);
    ...
    public function show1($id)
    {
        ...
        return view('customer.followed_store.show',compact('view'));
    }
    ...
    public function edit($id)
    {
        ...
        $record = role::find($id);         
         ...
         return view('customer.followed_store.edit',compact('record'));
