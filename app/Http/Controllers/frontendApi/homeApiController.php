...
$item_price=$items->item_price+$percent;
        ...
        if (!empty($items->item_offer_discount)) {
              ...
              $item_selling_price = round($item_price,2) - (round($item_price,2) * ($items->item_offer_discount / 100));
...
$addon_group_list=DB::table('product_addons')
->whereIn('product_addons.id',explode(',',$request->addon_check_id))
